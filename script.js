...
const dbEquipos = {
    ...
    "BARCELONA": [
        ...
        { name: "XAVI ESPART", rating: 68, positions: ["LD"] },
        { name: "RODRI", rating: 86, positions: ["MCD"] },
        ...
        { name: "ANTHONY GORDON", rating: 82, positions: ["EI", "DC", "ED"] },
        { name: "RAPHINHA", rating: 89, positions: ["EI", "MCO"] },
        { name: "JESSE BISIWU", rating: 65, positions: ["EI"] },
        { name: "LAMINE YAMAL", rating: 89, positions: ["ED"] },
        { name: "ADEYEMI", rating: 80, positions: ["ED"] },
        { name: "BARDGHJI", rating: 74, positions: ["ED"] },
        { name: "GABRIEL JESUS", rating: 80, positions: ["DC"] },
    ...
    "ATLETICO DE MADRID": [
        ...
        { name: "SALVI ESQUIVEL", rating: 70, positions: ["POR"] },
        { name: "ROMERO", rating: 85, positions: ["DFC"] },
    ...
    "VILLARREAL": [
        ...
        { name: "RUBEN GOMEZ", rating: 65, positions: ["POR"] },
        ...
        { name: "CARLOS ROMERO", rating: 79, positions: ["LI"] },
        ...
        { name: "NATHAN SALIBA", rating: 74, positions: ["MC"] },
        { name: "SANTI COMESAÑA", rating: 79, positions: ["MC", "MCD"] },
        { name: "CARLOS MACIA", rating: 68, positions: ["MC"] },
        { name: "ALASSANE DIATTA", rating: 65, positions: ["MC"] },
    ...
    "CELTA DE VIGO": [
        ...
        { name: "BAYINDIR", rating: 76, positions: ["POR"] },
        ...
        { name: "ABDOULAYE FAYE", rating: 72, positions: ["DFC"] },
        { name: "CACERES", rating: 73, positions: ["DFC"] },
        { name: "YOEL LAGO", rating: 71, positions: ["DFC"] },
        { name: "MARCOS ALONSO", rating: 79, positions: ["DFC", "LI"] },
        { name: "JAVI GALAN", rating: 74, positions: ["LI"] },
        { name: "CARREIRA", rating: 80, positions: ["LD"] },
        { name: "JAVI RUEDA", rating: 73, positions: ["LD"] },
        ...
        { name: "ALEIX FEBAS", rating: 78, positions: ["MC", "MCO"] },
        { name: "WILLIOT SWEDBERG", rating: 75, positions: ["EI", "MCO"] },
        { name: "HUGO ALVAREZ", rating: 75, positions: ["EI"] },
        { name: "DRIOUECH", rating: 73, positions: ["EI"] },
        { name: "JUTGLA", rating: 75, positions: ["ED", "DC"] },
        { name: "EL-ABDELLAOUI", rating: 70, positions: ["ED", "DC", "EI"] },
        { name: "HUGO GONZALEZ", rating: 65, positions: ["ED"] },
    ...
    "REAL SOCIEDAD": [
        ...
        { name: "JON MARTIN", rating: 77, positions: ["DFC"] },
        { name: "MAMADOU SARR", rating: 78, positions: ["DFC"] },
        ...
        { name: "HECTOR FORT", rating: 74, positions: ["LD"] },
    ...
    "ATHLETIC BILBAO": [
        ...
        { name: "MAROAN SANNADI", rating: 70, positions: ["DC"] }
    ],
