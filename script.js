...
const dbEquipos = {
    "REAL MADRID": [
        ...
        { name: "KONATE", rating: 84, positions: ["DFC"] },
        { name: "ASENCIO", rating: 78, positions: ["DFC", "LD"] },
        { name: "MILITAO", rating: 84, positions: ["DFC"] },
        { name: "RUDIGER", rating: 83, positions: ["DFC"] },
        { name: "CUCURELLA", rating: 86, positions: ["LI"] },
        { name: "CARRERAS", rating: 81, positions: ["LI"] },
        { name: "MENDY", rating: 80, positions: ["LI"] },
        { name: "ALEXANDER-ARNOLD", rating: 84, positions: ["LD"] },
        { name: "DUMFRIES", rating: 83, positions: ["LD"] },
        { name: "TCHOUAMENI", rating: 84, positions: ["MCD", "MC", "DFC"] },
        { name: "VALVERDE", rating: 87, positions: ["MC", "LD", "ED", "MCD"] },
        { name: "CAMAVINGA", rating: 81, positions: ["MCD", "MC", "LI"] },
        { name: "THIAGO PITARCH", rating: 70, positions: ["MC", "MCD", "MCO"] },
        { name: "CESTERO", rating: 64, positions: ["MC"] },
        { name: "BELLINGHAM", rating: 90, positions: ["MCO", "MC"] },
        { name: "ARDA GULER", rating: 83, positions: ["MC", "MCO", "ED"] },
        { name: "BERNARDO SILVA", rating: 84, positions: ["MC", "MCO", "ED"] },
        { name: "VINICIUS", rating: 89, positions: ["EI", "DC"] },
        { name: "DIOMANDE", rating: 84, positions: ["ED"] },
        { name: "RODRYGO", rating: 84, positions: ["EI", "DC", "ED"] },
        { name: "BRAHIM DIAZ", rating: 81, positions: ["ED"] },
        { name: "MBAPPE", rating: 91, positions: ["DC", "EI"] },
        { name: "ENDRICK", rating: 79, positions: ["DC", "ED"] },
        { name: "ESPI", rating: 77, positions: ["DC"] }
    ],
    
    "BARCELONA": [
        { name: "JOAN GARCIA", rating: 86, positions: ["POR"] },
        { name: "LIVAKOVIC", rating: 78, positions: ["POR"] },
        { name: "SZCZESNY", rating: 81, positions: ["POR"] },
        { name: "CUBARSI", rating: 86, positions: ["DFC"] },
        { name: "ERIC GARCIA", rating: 85, positions: ["DFC", "LD"] },
        { name: "GERARD MARTIN", rating: 79, positions: ["DFC", "LI"] },
        { name: "CHRISTENSEN", rating: 79, positions: ["MCD", "DFC"] },
        ...
        { name: "MARC BERNAL", rating: 78, positions: ["MCD", "MC"] },
        { name: "BRIAN FARINAS", rating: 68, positions: ["MC"] },
        { name: "FERMIN LOPEZ", rating: 85, positions: ["MC", "MCO"] },
        { name: "DANI OLMO", rating: 84, positions: ["MCO", "MC"] },
        { name: "ANTHONY GORDON", rating: 84, positions: ["EI", "DC", "ED"] },
        { name: "RAPHINHA", rating: 88, positions: ["EI", "MCO"] },
        { name: "JESSE BISIWU", rating: 67, positions: ["EI"] },
        { name: "LAMINE YAMAL", rating: 90, positions: ["ED"] },
        { name: "ADEYEMI", rating: 82, positions: ["ED"] },
        { name: "BARDGHJI", rating: 74, positions: ["ED"] },
        { name: "GABRIEL JESUS", rating: 79, positions: ["DC"] },
        { name: "HAMZA ABDELKARIM", rating: 65, positions: ["DC"] }
    ],
    
    "ATLETICO DE MADRID": [
        { name: "OBLAK", rating: 88, positions: ["POR"] },
        { name: "MUSSO", rating: 82, positions: ["POR"] },
        { name: "SALVI ESQUIVEL", rating: 64, positions: ["POR"] },
        { name: "ROMERO", rating: 82, positions: ["DFC"] },
        { name: "HANCKO", rating: 83, positions: ["LI", "DFC"] },
        { name: "PUBILL", rating: 81, positions: ["DFC", "LD"] },
        { name: "LE NORMAND", rating: 81, positions: ["DFC"] },
        { name: "JORGE DOMINGUEZ", rating: 70, positions: ["DFC"] },
        { name: "DANI MARTINEZ", rating: 63, positions: ["DFC"] },
        { name: "GRIMALDO", rating: 85, positions: ["LI", "MCO"] },
        { name: "MARCOS LLORENTE", rating: 85, positions: ["LD", "MC"] },
        { name: "HJULMAND", rating: 83, positions: ["MCD"] },
        ...
        { name: "KANG-IN LEE", rating: 80, positions: ["MCO"] },
        { name: "ALEX BAENA", rating: 83, positions: ["MC", "EI"] },
        { name: "LOOKMAN", rating: 83, positions: ["DC"] },
        { name: "ARNAU ORTIZ", rating: 69, positions: ["EI"] },
        { name: "GIULIANO SIMEONE", rating: 82, positions: ["ED"] },
        { name: "JULIAN ALVAREZ", rating: 86, positions: ["DC"] },
        { name: "JONATHAN DAVID", rating: 80, positions: ["DC"] },
        { name: "SORLOTH", rating: 83, positions: ["DC"] }
    ],
    
    "VILLARREAL": [
        { name: "LUIZ JUNIOR", rating: 78, positions: ["POR"] },
        { name: "GULACSI", rating: 72, positions: ["POR"] },
        { name: "RUBEN GOMEZ", rating: 63, positions: ["POR"] },
        { name: "RENATO VEIGA", rating: 78, positions: ["DFC"] },
        { name: "LOGAN COSTA", rating: 76, positions: ["DFC"] },
        { name: "PAU NAVARRO", rating: 74, positions: ["DFC", "LD"] },
        { name: "FOYTH", rating: 79, positions: ["DFC"] },
        { name: "CARLOS ROMERO", rating: 80, positions: ["LI"] },
        ...
        { name: "NATHAN SALIBA", rating: 71, positions: ["MC"] },
        { name: "SANTI COMESAÑA", rating: 79, positions: ["MC", "MCD"] },
        { name: "CARLOS MACIA", rating: 65, positions: ["MC"] },
        { name: "ALASSANE DIATTA", rating: 62, positions: ["MC"] },
        { name: "MOLEIRO", rating: 82, positions: ["MCO", "EI"] },
        { name: "ILIAS AKHOMACH", rating: 75, positions: ["ED"] },
    ...
    "REAL BETIS": [
        ...
        { name: "DIEGO CONDE", rating: 76, positions: ["POR"] },
        { name: "NATAN", rating: 79, positions: ["DFC"] },
        { name: "VALENTIN GOMEZ", rating: 76, positions: ["DFC", "LI"] },
        { name: "LLORENTE", rating: 79, positions: ["DFC"] },
        { name: "BARTRA", rating: 79, positions: ["DFC"] },
        { name: "FRAN GARCIA", rating: 77, positions: ["LI"] },
        { name: "JUNIOR FIRPO", rating: 74, positions: ["LI"] },
        { name: "ANGEL ORTIZ", rating: 70, positions: ["LD"] },
        { name: "BELLERIN", rating: 76, positions: ["LD"] },
        { name: "FACUNDO BERNAL", rating: 74, positions: ["MCD"] },
        ...
        { name: "DANI CEBALLOS", rating: 79, positions: ["MC"] },
        { name: "FIDALGO", rating: 77, positions: ["MC", "MCO", "MCD"] },
        { name: "LO CELSO", rating: 80, positions: ["MC", "MCO"] },
        { name: "ISCO", rating: 83, positions: ["MC", "MCO"] },
        { name: "IKER LOSADA", rating: 72, positions: ["MCO"] },
        { name: "ABDE", rating: 81, positions: ["EI"] },
        { name: "RIQUELME", rating: 76, positions: ["MCD", "MC"] },
        { name: "ANTONY", rating: 81, positions: ["ED"] },
        { name: "AITOR RUIBAL", rating: 77, positions: ["ED", "DC", "LD"] },
        { name: "TROY PARROTT", rating: 78, positions: ["DC"] },
        { name: "CUCHO HERNANDEZ", rating: 79, positions: ["DC"] }
    ],
    
    "CELTA DE VIGO": [
        { name: "RADU", rating: 78, positions: ["POR"] },
        { name: "BAYINDIR", rating: 75, positions: ["POR"] },
        ...
        { name: "ABDOULAYE FAYE", rating: 71, positions: ["DFC"] },
        { name: "CACERES", rating: 75, positions: ["DFC"] },
        { name: "YOEL LAGO", rating: 71, positions: ["DFC"] },
        { name: "MARCOS ALONSO", rating: 79, positions: ["DFC", "LI"] },
        { name: "JAVI GALAN", rating: 77, positions: ["LI"] },
        { name: "CARREIRA", rating: 76, positions: ["LD"] },
        { name: "JAVI RUEDA", rating: 76, positions: ["LD"] },
        ...
        { name: "ALEIX FEBAS", rating: 79, positions: ["MC", "MCO"] },
        { name: "WILLIOT SWEDBERG", rating: 76, positions: ["EI", "MCO"] },
        { name: "HUGO ALVAREZ", rating: 75, positions: ["EI"] },
        { name: "DRIOUECH", rating: 72, positions: ["EI"] },
        { name: "JUTGLA", rating: 75, positions: ["ED", "DC"] },
        { name: "EL-ABDELLAOUI", rating: 72, positions: ["ED", "DC", "EI"] },
        { name: "HUGO GONZALEZ", rating: 68, positions: ["ED"] },
    ...
    "REAL SOCIEDAD": [
        ...
        { name: "JON MARTIN", rating: 78, positions: ["DFC"] },
        { name: "MAMADOU SARR", rating: 77, positions: ["DFC"] },
        { name: "ZUBELDIA", rating: 77, positions: ["DFC"] },
        { name: "PACHECO", rating: 74, positions: ["DFC"] },
        { name: "SERGIO GOMEZ", rating: 78, positions: ["LI"] },
        { name: "AIHEN MUÑOZ", rating: 73, positions: ["LI"] },
        { name: "JON ARAMBURU", rating: 77, positions: ["LD"] },
        { name: "HECTOR FORT", rating: 72, positions: ["LD"] },
        { name: "ODRIOZOLA", rating: 73, positions: ["LD"] },
        { name: "GORROTXA", rating: 78, positions: ["MC", "MCD"] },
        { name: "BEÑAT TURRIENTES", rating: 76, positions: ["MC", "MCD"] },
        { name: "LUKA SUCIC", rating: 76, positions: ["MC", "MCO"] },
        { name: "CARLOS SOLER", rating: 79, positions: ["MC", "MCO"] },
        { name: "YANGEL HERRERA", rating: 78, positions: ["MC", "MCD"] },
        { name: "ZAKHARYAN", rating: 73, positions: ["MCO", "ED"] },
        { name: "PABLO MARIN", rating: 73, positions: ["MCO", "MC"] },
        { name: "BARRENETXEA", rating: 79, positions: ["EI"] },
        { name: "GUEDES", rating: 80, positions: ["EI", "DC"] },
        { name: "KUBO", rating: 80, positions: ["ED"] },
        { name: "JOB OCHIENG", rating: 68, positions: ["ED"] },
        { name: "OYARZABAL", rating: 84, positions: ["DC"] },
        { name: "OSKARSSON", rating: 74, positions: ["DC"] }
    ],
    
    "ATHLETIC BILBAO": [
        { name: "UNAI SIMON", rating: 85, positions: ["POR"] },
        { name: "ALEX PADILLA", rating: 69, positions: ["POR"] },
        { name: "VIVIAN", rating: 82, positions: ["DFC"] },
        { name: "LAPORTE", rating: 84, positions: ["DFC"] },
        { name: "PAREDES", rating: 78, positions: ["DFC"] },
        { name: "YERAY ALVAREZ", rating: 80, positions: ["DFC"] },
        { name: "UNAI EGILUZ", rating: 70, positions: ["DFC"] },
        { name: "YURI BERCHICHE", rating: 79, positions: ["LI"] },
        { name: "JESUS ARESO", rating: 76, positions: ["LD"] },
        { name: "HUGO RINCON", rating: 75, positions: ["LD"] },
        { name: "JOHANEKO LOUIS-JEAN", rating: 61, positions: ["LD"] },
        { name: "JAUREGIZAR", rating: 79, positions: ["MC", "MCD"] },
        { name: "BEÑAT PRADOS", rating: 77, positions: ["MC", "MCD"] },
        { name: "ALEJANDRO REGO", rating: 73, positions: ["MC", "MCD"] },
        { name: "RUIZ DE GALARRETA", rating: 79, positions: ["MCD", "MC"] },
        { name: "BEÑAT GERENABARRENA", rating: 70, positions: ["MC"] },
        { name: "OIHAN SANCET", rating: 82, positions: ["MCO", "MC"] },
        { name: "PEIO CANALES", rating: 73, positions: ["MCO", "MC"] },
        { name: "NICO WILLIAMS", rating: 84, positions: ["EI"] },
        { name: "BERENGUER", rating: 79, positions: ["EI", "ED", "MCO"] },
        { name: "ALVARO DJALO", rating: 74, positions: ["EI"] },
        { name: "NICO SERRANO", rating: 71, positions: ["EI", "ED"] },
        { name: "ROBERT NAVARRO", rating: 76, positions: ["EI", "ED"] },
        { name: "IÑAKI WILLIAMS", rating: 80, positions: ["ED", "DC"] },
    ...
    "VALENCIA": [
        ...
        { name: "VAN OEVELEN", rating: 69, positions: ["POR"] },
        { name: "CRISTIAN RIVERO", rating: 65, positions: ["POR"] },
        { name: "CESAR TARREGA", rating: 75, positions: ["DFC"] },
        { name: "JUSTIN DE HAAS", rating: 76, positions: ["DFC"] },
        { name: "COPETE", rating: 74, positions: ["DFC"] },
        { name: "DIAKHABY", rating: 76, positions: ["DFC"] },
        { name: "IKER CORDOBA", rating: 65, positions: ["DFC"] },
        { name: "GAYA", rating: 77, positions: ["LI"] },
        { name: "JESUS VAZQUEZ", rating: 71, positions: ["LI"] },
        { name: "ARNAU MARTINEZ", rating: 77, positions: ["LD"] },
        { name: "MAFFEO", rating: 77, positions: ["LD"] },
        { name: "FOULQUIER", rating: 72, positions: ["LD"] },
        { name: "PEPELU", rating: 76, positions: ["MC", "MCD"] },
        { name: "GUIDO RODRIGUEZ", rating: 78, positions: ["MC", "MCD"] },
        { name: "ALIOU DIENG", rating: 73, positions: ["MCD"] },
        { name: "JAVI GUERRA", rating: 77, positions: ["MC", "MCO", "MCD"] },
        { name: "UGRINIC", rating: 75, positions: ["MCO", "MC"] },
        { name: "HARVEY ELLIOTT", rating: 77, positions: ["MCO", "ED"] },
        { name: "DANJUMA", rating: 75, positions: ["EI", "DC"] },
        { name: "SATO", rating: 71, positions: ["EI"] },
        { name: "SERGI CANOS", rating: 68, positions: ["EI"] },
        { name: "DIEGO LOPEZ", rating: 77, positions: ["ED", "EI"] },
        { name: "LUIS RIOJA", rating: 77, positions: ["ED"] },
        { name: "DAVID OTORBI", rating: 64, positions: ["ED"] },
    ...
    "SEVILLA": [
        ...
        { name: "SANGANTE", rating: 74, positions: ["DFC", "LD"] },
        { name: "ANDRES CASTRIN", rating: 73, positions: ["DFC"] },
        { name: "MARCAO", rating: 73, positions: ["DFC"] },
        { name: "FABIO CARDOSO", rating: 73, positions: ["DFC"] },
        { name: "SUAZO", rating: 74, positions: ["LI"] },
        { name: "JULIO DIAZ", rating: 68, positions: ["LI"] },
        { name: "CARMONA", rating: 77, positions: ["DFC", "LD"] },
        { name: "JUAN IGLESIAS", rating: 76, positions: ["LI", "LD"] },
        { name: "YOUSSOUF FOFANA", rating: 80, positions: ["MCD"] },
        { name: "AGOUME", rating: 76, positions: ["MC", "MCD"] },
        { name: "KOCHORASHVILI", rating: 73, positions: ["MC", "MCO"] },
        { name: "GURIDI", rating: 73, positions: ["MC", "MCO"] },
        { name: "MANU BUENO", rating: 67, positions: ["MC", "MCD", "MCO"] },
        { name: "NICO GUILLEN", rating: 65, positions: ["MC"] },
        { name: "RUBEN VARGAS", rating: 78, positions: ["ED", "EI", "MCO"] },
        { name: "FELIX CORREIA", rating: 75, positions: ["EI", "ED"] },
        { name: "EJUKE", rating: 76, positions: ["EI"] },
        { name: "ALFON GONZALEZ", rating: 75, positions: ["EI", "MCO", "DC"] },
        { name: "MIGUEL SIERRA", rating: 65, positions: ["ED", "EI"] },
        { name: "PEQUE", rating: 74, positions: ["DC", "MCO"] },
        { name: "LUCAS STASSIN", rating: 74, positions: ["DC", "MCO"] },
        { name: "ROBBIE URE", rating: 71, positions: ["DC"] },
    ...
    "ALAVES": [
        { name: "ANTONIO SIVERA", rating: 78, positions: ["POR"] },
        { name: "ADRIAN RODRIGUEZ", rating: 65, positions: ["POR"] },
        { name: "NICOLAS VALENTINI", rating: 74, positions: ["DFC"] },
        { name: "VILLE KOSKI", rating: 70, positions: ["DFC"] },
        { name: "FACUNDO GARCES", rating: 72, positions: ["DFC"] },
        { name: "YOUSSEF ENRIQUEZ", rating: 72, positions: ["LI"] },
        { name: "NAHUEL TENAGLIA", rating: 74, positions: ["LD"] },
        { name: "JONNY OTTO", rating: 75, positions: ["LD"] },
        { name: "HUGO NOVOA", rating: 68, positions: ["LD"] },
        ...
        { name: "DENIS SUAREZ", rating: 74, positions: ["MCO"] },
        { name: "ABDE REBBACH", rating: 72, positions: ["EI"] },
        { name: "MIGUEL RODRIGUEZ", rating: 74, positions: ["ED"] },
        { name: "ANGEL PEREZ", rating: 72, positions: ["ED"] },
        { name: "TONI MARTINEZ", rating: 76, positions: ["DC"] },
        { name: "LUCAS BOYE", rating: 77, positions: ["DC"] },
        { name: "AITOR MANAS", rating: 65, positions: ["DC"] },
        { name: "MARIANO DIAZ", rating: 70, positions: ["DC"] }
    ],
    
    "DEPORTIVO CORUÑA": [
        { name: "LEO ROMAN", rating: 76, positions: ["POR"] },
        { name: "ALVARO FERLLO", rating: 72, positions: ["POR"] },
        { name: "GERMAN PARREÑO", rating: 68, positions: ["POR"] },
        { name: "JOSE MARIA GIMENEZ", rating: 82, positions: ["DFC"] },
        { name: "LUCAS NOUBI", rating: 70, positions: ["DFC"] },
        { name: "DANI BARCIA", rating: 70, positions: ["DFC"] },
        { name: "BRIGHT EDE", rating: 65, positions: ["DFC"] },
        { name: "ARNAU COMAS", rating: 68, positions: ["DFC"] },
        { name: "ANGELIÑO", rating: 78, positions: ["LI"] },
        { name: "GIACOMO QUAGLIATA", rating: 72, positions: ["LI"] },
        { name: "ADRIA ALTIMIRA", rating: 72, positions: ["LD"] },
        { name: "MIGUEL LOUREIRO", rating: 70, positions: ["LD"] },
        { name: "XIMO NAVARRO", rating: 68, positions: ["LD"] },
        { name: "MARC CASADO", rating: 80, positions: ["MCD"] },
        { name: "LORENZO AMATUCCI", rating: 75, positions: ["MCD"] },
        { name: "RIKI RODRIGUEZ", rating: 72, positions: ["MC"] },
        { name: "DIEGO VILLARES", rating: 70, positions: ["MC"] },
        { name: "NOE CARRILLO", rating: 68, positions: ["MC"] },
        { name: "TEUN GIJSELHART", rating: 65, positions: ["MC"] },
        { name: "MARIO SORIANO", rating: 75, positions: ["MCO"] },
        { name: "JONATHAN ASP JENSEN", rating: 72, positions: ["MCO"] },
        { name: "YEREMAY HERNANDEZ", rating: 80, positions: ["EI"] },
        { name: "ADAMA TRAORE", rating: 78, positions: ["ED"] },
        { name: "DAVID MELLA", rating: 74, positions: ["ED"] },
        { name: "LUISMI CRUZ", rating: 72, positions: ["ED"] },
        { name: "BIL NSONGO", rating: 72, positions: ["DC"] },
        { name: "AUBAMEYANG", rating: 80, positions: ["DC"] },
        { name: "ZAKARIA EDDAHCHOURI", rating: 73, positions: ["DC"] }
    ],
    
    "ESPANYOL": [
        { name: "MARKO DMITROVIC", rating: 74, positions: ["POR"] },
        { name: "ANGEL FORTUÑO", rating: 68, positions: ["POR"] },
        { name: "VANJA DRKUSIC", rating: 75, positions: ["DFC"] },
        { name: "CLEMENS RIEDEL", rating: 74, positions: ["DFC"] },
        { name: "UNAI NUÑEZ", rating: 76, positions: ["DFC"] },
        { name: "LEANDRO CABRERA", rating: 74, positions: ["DFC"] },
        { name: "QUILINDSCHY HARTMAN", rating: 80, positions: ["LI"] },
        { name: "ROGER HINOJO", rating: 68, positions: ["LI"] },
        { name: "OMAR EL HILALI", rating: 79, positions: ["LD"] },
        { name: "ANDONI GOROSABEL", rating: 76, positions: ["LD"] },
        { name: "URKO GONZALEZ", rating: 78, positions: ["MCD"] },
        { name: "GABRIEL MOSCARDO", rating: 75, positions: ["MCD"] },
        { name: "POL LOZANO", rating: 76, positions: ["MC"] },
        { name: "EDU EXPOSITO", rating: 77, positions: ["MC"] },
        { name: "RAFEL BAUZA", rating: 70, positions: ["MC"] },
        { name: "ALEX CALATRAVA", rating: 74, positions: ["MCO"] },
        { name: "JAVI HERNANDEZ", rating: 70, positions: ["MCO"] },
        { name: "BRYAN ZARAGOZA", rating: 78, positions: ["EI"] },
        { name: "JAVI PUADO", rating: 79, positions: ["EI"] },
        { name: "PERE MILLA", rating: 74, positions: ["EI"] },
        { name: "TYRHYS DOLAN", rating: 77, positions: ["ED"] },
        { name: "JOFRE CARRERAS", rating: 74, positions: ["ED"] },
        { name: "ROBERTO FERNANDEZ", rating: 77, positions: ["DC"] },
        { name: "MARCOS FERNANDEZ", rating: 70, positions: ["DC"] },
        { name: "KIKE GARCIA", rating: 74, positions: ["DC"] }
    ],
    
    "MALAGA": [
        { name: "ALFONSO HERRERO", rating: 72, positions: ["POR"] },
        { name: "CARLOS LOPEZ", rating: 65, positions: ["POR"] },
        { name: "FERNANDO CALERO", rating: 74, positions: ["DFC"] },
        { name: "DIEGO MURILLO", rating: 72, positions: ["DFC"] },
        { name: "JUAN BERROCAL", rating: 72, positions: ["DFC"] },
        { name: "EINAR GALILEA", rating: 70, positions: ["DFC"] },
        { name: "ALEX PASTOR", rating: 68, positions: ["DFC"] },
        { name: "ANGEL RECIO", rating: 68, positions: ["DFC"] },
        { name: "ADAM AZNOU", rating: 75, positions: ["LI"] },
        { name: "JOSE SALINAS", rating: 73, positions: ["LI"] },
        { name: "RAFITA GARRIDO", rating: 68, positions: ["LD"] },
        { name: "CARLOS PUGA", rating: 68, positions: ["LD"] },
        { name: "JENS CAJUSTE", rating: 77, positions: ["MCD"] },
        { name: "PABLO MARTINEZ", rating: 74, positions: ["MC"] },
        { name: "IZAN MERINO", rating: 70, positions: ["MC"] },
        { name: "CARLOS DOTOR", rating: 70, positions: ["MC"] },
        { name: "RAMON ENRIQUEZ", rating: 65, positions: ["MC"] },
        { name: "DANI LORENZO", rating: 70, positions: ["MCO"] },
        { name: "RAFA RODRIGUEZ", rating: 68, positions: ["MCO"] },
        { name: "AARON OCHOA", rating: 65, positions: ["MCO"] },
        { name: "JUAN CRUZ", rating: 72, positions: ["EI"] },
        { name: "JOAQUIN MUÑOZ", rating: 72, positions: ["EI"] },
        { name: "JULEN LOBETE", rating: 70, positions: ["EI"] },
        { name: "DAVID LARRUBIA", rating: 74, positions: ["ED"] },
        { name: "HAITAM ABAIDA", rating: 65, positions: ["ED"] },
        { name: "CHUPE", rating: 76, positions: ["DC"] },
        { name: "ADRIAN NIÑO", rating: 72, positions: ["DC"] },
        { name: "ENEKO JAUREGI", rating: 70, positions: ["DC"] }
    ],
    
    "ELCHE": [
        { name: "ALEJANDRO ITURBE", rating: 72, positions: ["POR"] },
        { name: "MATIAS DITURO", rating: 74, positions: ["POR"] },
        { name: "KEVIN LOMONACO", rating: 76, positions: ["DFC"] },
        { name: "VICTOR CHUST", rating: 75, positions: ["DFC"] },
        { name: "MATIA BARZIC", rating: 68, positions: ["DFC"] },
        { name: "BAMBO DIABY", rating: 70, positions: ["DFC"] },
        { name: "PEDRO BIGAS", rating: 72, positions: ["DFC"] },
        ...
        { name: "JAVI MORCILLO", rating: 65, positions: ["MC"] },
        { name: "FACUNDO BUONANOTTE", rating: 78, positions: ["MCO"] },
        { name: "THOMAS LEMAR", rating: 78, positions: ["MCO"] },
        { name: "GERMAN VALERA", rating: 75, positions: ["EI"] },
        { name: "LUCAS CEPEDA", rating: 72, positions: ["EI"] },
        { name: "TETE MORENTE", rating: 74, positions: ["EI"] },
        { name: "YAGO SANTIAGO", rating: 68, positions: ["EI"] },
        { name: "GRADY DIANGANA", rating: 74, positions: ["ED"] },
        { name: "JOSAN", rating: 70, positions: ["ED"] },
        { name: "ADAM BOAYAR", rating: 68, positions: ["MCO"] },
        { name: "ALI HOUARY", rating: 65, positions: ["MCO"] },
        { name: "EZEQUIEL PONCE", rating: 76, positions: ["DC"] },
        { name: "FER NIÑO", rating: 73, positions: ["DC"] },
        { name: "ABIEL OSORIO", rating: 70, positions: ["DC"] }
    ]
};
